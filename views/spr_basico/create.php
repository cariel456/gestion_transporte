...
$solicitantes = getAllSolicitantes();
    ...
    <div class="container mt-5">
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="nivel_urgencia" name="nivel_urgencia" placeholder="1 PARA URGENTE, 2 PARA MEDIO Y 3 PARA BAJO">
            </div>
            ...
            <div class="mb-3">
                <label for="observaciones" class="form-label">Pedido Detalles</label>
                <textarea class="form-control" id="observaciones" name="observaciones" rows="3" placeholder="DESCRIBA AQUI SU O SUS PEDIDOS"></textarea>
            </div>
