                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control select2" id="solicitante" name="solicitante">
                        ...
                        <?php foreach ($personal as $solicitante) : ?>
                            <option value="<?php echo $solicitante['id']; ?>" <?php echo (isset($_GET['solicitante']) && $_GET['solicitante'] == $solicitante['id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($solicitante['nombre_personal']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control select2" id="ubicacion" name="ubicacion">
                        ...
                        <?php foreach ($localidades as $localidad): ?>
                            <option value="<?php echo $localidad['id']; ?>" <?php echo (isset($_GET['ubicacion']) && $_GET['ubicacion'] == $localidad['id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($localidad['nombre_localidad']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control select2" id="numero_unidad" name="numero_unidad">
                        ...
                        <?php foreach ($unidades as $unidad): ?>
                            <option value="<?php echo $unidad['id']; ?>" <?php echo (isset($_GET['numero_unidad']) && $_GET['numero_unidad'] == $unidad['id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($unidad['codigo_interno']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control select2" id="conductor" name="conductor">
                        ...
                        <?php foreach ($personal as $persona): ?>
                            <option value="<?php echo $persona['id']; ?>" <?php echo (isset($_GET['conductor']) && $_GET['conductor'] == $persona['id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($persona['nombre_personal']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="col-md-3 mb-3">
                    ...
                    <select class="form-control select2" id="mantenimiento" name="mantenimiento">
                        <option value="">Seleccione...</option>
                        <?php foreach ($personal as $persona): ?>
                            <option value="<?php echo $persona['id']; ?>" <?php echo (isset($_GET['mantenimiento']) && $_GET['mantenimiento'] == $persona['id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($persona['nombre_personal']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
