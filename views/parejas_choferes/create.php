...
if (!checkPermission('parejas_choferes', 'crear')) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (createParejaChoferes($data)) {
        header("Location: read.php");
        exit();
    } else {
        $error = "Error al crear la pareja de choferes";
    }
}
...
<head>
    ...
    <title>Crear Pareja de Choferes</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h1>Crear Pareja de Choferes</h1>
